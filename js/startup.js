...
const loadQueueModal = () => {
        ...
        $('body').prepend('<div class="queue-modal"><div class="queue-modal-content"><div class="queue-details"><div class="server-header"><button id="queue-settings" type="button" class="btn btn-secondary"><i class="bi bi-gear"></i></button><h3 class="header-text">My Queue</h3><div id="close-btn" class="server-header-btn"><i class="bi bi-x-lg"></i></div></div><table class="queue-table"><tbody><tr class="queue-table-headers"><th>Order</th><th>Name</th></tr></tbody></table><div class="queue-button-panel"><div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups"><div class="btn-group me-2" role="group" aria-label="First group" style="margin-right: 15px;"><button id="btnQueueClear" type="button" class="btn btn-danger"><i class="bi bi-trash"></i></button><button id="btnShuffleQueue" type="button" class="btn btn btn-secondary"><i class="bi bi-shuffle"></i></button></div><div class="input-group"><input type="text" class="form-control" placeholder="Search..."><div class="input-group-append"><button class="btn btn-secondary" type="button"><i class="bi bi-search"></i></button></div></div></div></div></div></div></div>');
